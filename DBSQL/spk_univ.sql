...
--
-- Host: localhost
-- Generation Time: Aug 09, 2016 at 04:01 AM
...
(1, 4, '5.0', '4 tingkat di atas'),
(2, 3, '4.5', '3 tingkat di atas'),
(3, 2, '4.0', '2 tingkat di atas'),
(4, 1, '3.5', '1 tingkat di atas'),
(5, 0, '3.0', 'cukup baik'),
(6, -1, '2.5', '1 tingkat di bawah'),
(7, -2, '2.0', '2 tingkat di bawah'),
(8, -3, '1.5', '3 tingkat di bawah'),
(9, -4, '1.0', '4 tingkat di bawah');
...
INSERT INTO `indikator` (`id`, `dim`, `keterangan`, `nilai`, `kelompok`) VALUES
(1, 1, 'Pengguna merasa mudah untuk mempelajari pengoperasian website', 4, 'core'),
(2, 1, 'Interaksi antara website dengan pengguna jelas dan mudah dipahami', 4, 'core'),
(3, 1, 'Pengguna merasa mudah untuk bernavigasi dalam website', 4, 'core'),
(4, 1, 'Pengguna merasa website mudah untuk digunakan', 4, 'core'),
(5, 1, 'Website memiliki tampilan yang menarik', 3, 'secondary'),
(6, 1, 'Desain sesuai dengan jenis website', 3, 'secondary'),
(7, 1, 'Website mengandung kompetensi', 4, 'core'),
(8, 1, 'Website menciptakan pengalaman positif bagi pengguna', 3, 'secondary'),
(9, 2, 'Website memiliki reputasi yang baik', 3, 'secondary'),
(10, 2, 'Pengguna merasa aman untuk melakukan transaksi', 4, 'core'),
(11, 2, 'Pengguna merasa aman terhadap informasi pribadinya', 4, 'core'),
(12, 2, 'Website memberi ruang untuk personalisasi', 3, 'secondary'),
(13, 2, 'Website memberi ruang untuk komunitas', 3, 'secondary'),
(14, 2, 'Website memberikan kemudahan untuk berkomunikasi dengan organisasi', 3, 'secondary'),
(15, 2, 'Pengguna merasa yakin bahwa jasa akan dikirim sebagaimana yang telah dijanjikan', 3, 'secondary'),
(16, 3, 'Website menyajikan informasi yang akurat', 5, 'core'),
(17, 3, 'Website menyajikan informasi yang terpercaya', 5, 'core'),
(18, 3, 'Website menyajikan informasi yang tepat waktu', 5, 'core'),
(19, 3, 'Website menyajikan informasi yang relevan', 5, 'core'),
(20, 3, 'Website menyajikan informasi yang mudah dipahami', 5, 'core'),
(21, 3, 'Website menyajikan informasi yang sesuai dengan tingkatan', 4, 'secondary'),
(22, 3, 'Website menyajikan informasi yang sesuai dengan format', 4, 'secondary');
...
INSERT INTO `tbl_users` (`user_id`, `user_name`, `user_email`, `user_password`, `join_date`) VALUES
(1, 'admin', 'admin@spkuniv.com', 'admin123', '2016-08-09 00:04:55');
